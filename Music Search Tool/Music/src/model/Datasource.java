...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\vtriw\\IdeaProjects\\Music\\" + DB_NAME;
    ...
    public void querySongMeteData() {
        ...
        try (Statement statement = conn.createStatement();
            ...
            for (int i = 1; i < numColumns; i++) {
                System.out.format("Column %d int the songs table is name %s\n", i, meta.getColumnName(i));
            }
        } catch (SQLException e) {
            System.out.println("Query failed: " + e.getMessage());
        }
